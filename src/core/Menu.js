...
import { Group, Hd } from '@material-ui/icons';
      ...
      <div style={{ backgroundColor: '#404040' }}>
        ...
        <MenuItem>
          <Link style={isActive(history, '/shop')} to='/shop'>
            <IconButton aria-label='Shop' color='inherit' style={{'borderRadius': '0px'}}>
              <StorefrontIcon />
            </IconButton>
            Shop
          </Link>
        ...
        <MenuItem>
          <Link style={isActive(history, '/cart')} to='/cart'>
            <IconButton aria-label='Cart' color='inherit' style={{'borderRadius': '0px'}}>
        ...
        <MenuItem>
          <Link style={isActive(history, '/about-us')} to='/about-us'>
            About Us
          </Link>
        </MenuItem>
        {isAuthenticated() && isAuthenticated().user.role === 0 && (
          <MenuItem>
            <Link
              ...
              to='/user/dashboard'
            >
              <IconButton aria-label='Dashboard' color='inherit' style={{'borderRadius': '0px'}}>
                <DashboardIcon />
              </IconButton>
              Dashboard
            </Link>
      ...
      <AppBar position='fixed'>
        <Toolbar>
          <a href='/' style={{ color: '#ffffff' }}>
            ...
            >
              {/* <AttachMoneyIcon />  */}
              <MonetizationOnIcon style={{'fontSize': '35px'}}/>
            </IconButton>
          </a>
          ...
          <div className={classes.sectionDesktop}>
            ...
            <Link style={isActive(history, '/shop')} to='/shop'>
              <IconButton aria-label='Shop' color='inherit' style={{'borderRadius': '0px'}}>
                <StorefrontIcon />
                <Typography noWrap>Products</Typography>  
              </IconButton>
            </Link>
            ...
            <Link style={isActive(history, '/blog-list')} to='/blog-list'>
              <IconButton aria-label='About-Us' color='inherit' style={{'borderRadius': '0px'}}>
                <Typography noWrap>Charitable Contribution</Typography>
              </IconButton>
            </Link>
            {isAuthenticated() && isAuthenticated().user.role === 1 && (
              <Link style={isActive(history, '/posts/new')} to='/posts/new'>
                <IconButton aria-label='About-Us' color='inherit' style={{'borderRadius': '0px'}}>
                  <Typography noWrap>New Post</Typography>
                </IconButton>
              </Link>
            )}
            <Link style={isActive(history, '/about-us')} to='/about-us'>
